...
class Upgrade:
    ...
    def input(self):
        ...
        if self.can_move:
            if keys[
                pygame.K_RIGHT] and self.selection_index < self.attribute_nr - 1:
...
class Item:
    ...
    def display_bar(self, surface, value, max_value, selected):
        ...
        value_rect = pygame.Rect(top[0] - 15, bottom[1] - relative_number, 30,
                                 10)
    ...
    def trigger(self, player):
        ...
        if player.exp >= player.upgrade_cost[upgrade_attribute] and \
                player.stats[upgrade_attribute] < player.max_stats[
            upgrade_attribute]:
            player.exp -= player.upgrade_cost[upgrade_attribute]
            player.stats[upgrade_attribute] *= 1.2
            player.upgrade_cost[upgrade_attribute] *= 1.4

        if player.stats[upgrade_attribute] > player.max_stats[
            upgrade_attribute]:
            player.stats[upgrade_attribute] = player.max_stats[
                upgrade_attribute]
